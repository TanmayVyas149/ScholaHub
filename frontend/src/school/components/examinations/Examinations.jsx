...
React.useEffect(() => {
  ...
  return (
    ...
    <Paper>
      ...
      >
        {editId? <Typography variant='h5'>Edit Exam</Typography> :    <Typography variant='h5'>Add New Exam</Typography>}
     
        <LocalizationProvider dateAdapter={AdapterDayjs} style={{}} fullWidth>
        ...
        <TextField fullWidth
         name="examType"
          ...
          id="standard-basic" label="Exam type" variant="filled" />
        {Formik.touched.examType && Formik.errors.examType &&
          ...
          {editId &&   <Button type='button' variant="outlined" sx={{marginTop:'10px'}} onClick={handleEditCancel}>Cancel</Button>}
            ...
            {examinations.map((examination) => (
              ...
              >
                ...
                <TableCell align="right">
                  <Button varainat="contained" sx={{background:"skyblue"}}
                  onClick={()=>{
                  ...
                  Edit
                    ...
                    <Button varainat="contained" sx={{background:"tomato"}}
                  onClick={()=>{
